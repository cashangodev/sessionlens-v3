...
Client: Honestly? I barely notice it anymore. It's just... the background noise. It's how I operate. Get up, perform, don't complain. Weekends I'm usually so wiped I just zone out watching TV. I don't really do anything.`,
  analysis_result: {
    ...
    // 3 similar cases — each enriched with helpfulMoments (turning-point
    // quotes in the participant's own words) and a journey arc (dominant
    // structures early vs late in their story). These power the "What this
    // person said helped them" and "Their journey" panels in the Similar
    // Stories deep-dive.
    similarCases: [
      {
        id: 1,
        ...
        ageRange: '30-40',
        gender: 'male',
        primaryTopic: 'Perfectionism and inherited achievement pressure',
        ...
        matchBasis: 'Shares the body+emotion+cognitive triad with a narrative thread of inherited performance pressure — the same pattern showing up in this session.',
        helpfulMoments: [
          {
            quote: 'I realized I was running on my father\'s operating system. Once I saw the code, I could start rewriting it.',
            timestamp: 'session 4',
            structures: ['narrative' as const, 'reflective' as const, 'cognitive' as const],
          },
          {
            quote: 'The first night I let myself stop work at 7pm without finishing the deck, my chest didn\'t tighten. That had never happened. That\'s when I knew the chest tightness wasn\'t a medical thing — it was a permission thing.',
            timestamp: 'session 6',
            structures: ['body' as const, 'behaviour' as const, 'immediate_experience' as const],
          },
          {
            quote: 'I stopped trying to be the best engineer in the room and started asking what I actually wanted to build. Sleep came back the same week.',
            timestamp: 'session 8',
            structures: ['narrative' as const, 'normative' as const, 'reflective' as const],
          },
        ],
        journey: {
          early: ['body' as const, 'emotion' as const, 'cognitive' as const],
          late: ['reflective' as const, 'narrative' as const, 'normative' as const],
          momentCount: 42,
        },
      },
      {
        ...
        ageRange: '25-35',
        gender: 'female',
        primaryTopic: 'Impostor syndrome and rumination',
        ...
        matchBasis: 'Same emotion+cognitive loop with rumination at night — the structural fingerprint matches this client\'s late-night thought spiral.',
        helpfulMoments: [
          {
            quote: 'The therapist asked me to name the thought instead of arguing with it. "Oh, there\'s the I-don\'t-belong-here thought again." It lost its teeth almost immediately. I couldn\'t believe something that simple worked.',
            timestamp: 'session 3',
            structures: ['cognitive' as const, 'reflective' as const],
          },
          {
            quote: 'I used to think my anxiety was the enemy. Now I see it as an alarm system that got stuck — I don\'t need to fight it, I need to recalibrate it.',
            timestamp: 'session 7',
            structures: ['reflective' as const, 'emotion' as const, 'narrative' as const],
          },
          {
            quote: 'My partner asked what I wanted for dinner and I said what I actually wanted instead of "whatever\'s easy." That tiny moment — that was when I knew I was getting better.',
            timestamp: 'session 10',
            structures: ['social' as const, 'behaviour' as const, 'normative' as const],
          },
        ],
        journey: {
          early: ['emotion' as const, 'cognitive' as const, 'body' as const],
          late: ['reflective' as const, 'social' as const, 'behaviour' as const],
          momentCount: 51,
        },
      },
      {
        ...
        ageRange: '35-45',
        gender: 'female',
        primaryTopic: 'Body keeping score — somatic override',
        ...
        matchBasis: 'Body-led presentation with the same somatic-override pattern — chest tightness here mirrors the jaw clenching and headaches she described.',
        helpfulMoments: [
          {
            quote: 'I started doing a one-minute body scan before opening Slack. Just one minute. The headaches dropped by half in a week. I\'d been carrying so much tension I\'d forgotten what neutral felt like.',
            timestamp: 'session 2',
            structures: ['body' as const, 'immediate_experience' as const, 'behaviour' as const],
          },
          {
            quote: 'My body was keeping score of every deadline I white-knuckled through. Learning to listen to it instead of override it changed everything.',
            timestamp: 'session 5',
            structures: ['body' as const, 'reflective' as const, 'narrative' as const],
          },
          {
            quote: 'I told my manager "I need to step away for ten minutes" instead of grinding through a panic moment. The world didn\'t end. I think that\'s the sentence that changed my life.',
            timestamp: 'session 7',
            structures: ['social' as const, 'behaviour' as const, 'normative' as const],
          },
        ],
        journey: {
          early: ['body' as const, 'emotion' as const, 'immediate_experience' as const],
          late: ['reflective' as const, 'social' as const, 'behaviour' as const],
          momentCount: 38,
        },
      },
