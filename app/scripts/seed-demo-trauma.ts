    ...
    similarCases: [
      {
        ...
        ageRange: '26-35',
        gender: 'female',
        primaryTopic: 'Attachment-trauma panic in intimate relationships',
        ...
        representativeQuote: 'I spent my whole life apologizing for having needs. The first time I asked for one without saying sorry was terrifying.',
        matchBasis: 'Same body+emotion+social trio activating around partner withdrawal, with childhood emotional neglect as the underlying schema.',
        helpfulMoments: [
          {
            quote: "I started catching the chest tightness before the thought caught up. Just naming it as a feeling, not a fact, was the first thing that helped.",
            timestamp: '00:08:14',
            momentId: 3,
            structures: ['body' as const, 'reflective' as const],
          },
          {
            quote: "Once I told my partner 'I'm not mad at you, I'm scared,' something opened. Saying the actual fear made it less mine alone.",
            timestamp: '00:14:42',
            momentId: 7,
            structures: ['social' as const, 'narrative' as const],
          },
          {
            quote: "I had to write down what happened with my mom. Reading it later in my own handwriting was when it stopped being a vague heaviness and became a story I could hold.",
            timestamp: '00:21:08',
            momentId: 11,
            structures: ['narrative' as const, 'reflective' as const],
          },
        ],
        journey: {
          early: ['body' as const, 'emotion' as const],
          late: ['narrative' as const, 'reflective' as const],
          momentCount: 18,
        },
      },
      {
        ...
        ageRange: '36-45',
        gender: 'female',
        primaryTopic: 'Body-held abandonment grief',
        ...
        representativeQuote: 'My body was telling me what my words couldn\'t — that the little girl inside me was still waiting by that door.',
        matchBasis: 'Same somatic-first processing pathway: physical symptoms preceding conscious recognition of the abandonment schema.',
        helpfulMoments: [
          {
            quote: "The first time the panic came and I didn't try to make it stop — just let it move through — it was like watching a wave from the shore instead of drowning in it.",
            timestamp: '00:06:55',
            momentId: 4,
            structures: ['body' as const, 'immediate_experience' as const],
          },
          {
            quote: "I started telling my body it was safe out loud, even when it didn't believe me. That sounded ridiculous to me at first. It worked anyway.",
            timestamp: '00:12:30',
            momentId: 8,
            structures: ['body' as const, 'reflective' as const],
          },
          {
            quote: "I noticed the numbness in my hands always came right before I started apologizing. Once I saw the link, the apologizing stopped on its own.",
            timestamp: '00:19:47',
            momentId: 13,
            structures: ['body' as const, 'cognitive' as const, 'reflective' as const],
          },
        ],
        journey: {
          early: ['body' as const, 'emotion' as const],
          late: ['cognitive' as const, 'reflective' as const],
          momentCount: 22,
        },
      },
      {
        ...
        ageRange: '36-45',
        gender: 'female',
        primaryTopic: 'Reauthoring a childhood that was minimized',
        ...
        matchBasis: 'Same minimization defense ("she did her best") around emotional neglect, with the narrative-reflective shift as the way through.',
        helpfulMoments: [
          {
            quote: "Telling someone the actual story — not the version where I made my mom the hero — was the hardest hour of my life and the start of everything changing.",
            timestamp: '00:11:22',
            momentId: 6,
            structures: ['narrative' as const, 'social' as const],
          },
          {
            quote: "I realized I'd been having the same fight with people for fifteen years and the other person was always interchangeable. The fight was mine.",
            timestamp: '00:18:05',
            momentId: 12,
            structures: ['cognitive' as const, 'reflective' as const],
          },
          {
            quote: "I learned that 'I miss you' is a complete sentence. I don't have to follow it with an apology or an explanation.",
            timestamp: '00:26:40',
            momentId: 19,
            structures: ['social' as const, 'narrative' as const],
          },
        ...
        journey: {
          early: ['emotion' as const, 'social' as const],
          late: ['narrative' as const, 'reflective' as const],
          momentCount: 25,
        },
      },
      {
        ...
        ageRange: '26-35',
        gender: 'female',
        primaryTopic: 'Panic as suppressed needs surfacing',
        ...
        matchBasis: 'Same paradox: needs suppressed until the body expresses them as panic — and both responded to reframing panic as communication rather than pathology.',
        helpfulMoments: [
          {
            quote: "The panic was always asking the same question: 'Are you going to leave?' Once I knew that's what it was asking, I could answer it before it had to scream.",
            timestamp: '00:09:30',
            momentId: 5,
            structures: ['cognitive' as const, 'emotion' as const, 'reflective' as const],
          },
          {
            quote: "I started saying small needs out loud — 'I want to leave the party in an hour' — instead of waiting for someone to read me. That practice made the big ones possible later.",
            timestamp: '00:16:18',
            momentId: 10,
            structures: ['behaviour' as const, 'social' as const],
          },
          {
            quote: "I realized my breath was held all day, every day. Just exhaling on purpose was the first medicine. Free, available everywhere, and I'd been ignoring it for thirty years.",
            timestamp: '00:23:55',
            momentId: 15,
            structures: ['body' as const, 'behaviour' as const, 'reflective' as const],
          },
        ],
        journey: {
          early: ['body' as const, 'emotion' as const],
          late: ['behaviour' as const, 'cognitive' as const],
          momentCount: 19,
        },
      },
      {
        ...
        ageRange: '46-60',
        gender: 'female',
        primaryTopic: 'Letting anger be the door, not the destination',
        ...
        matchBasis: 'Same long-held loyalty to a neglecting parent ("she did her best") with anger emergence as the unblocking move.',
        helpfulMoments: [
          {
            quote: "I had to let myself be angry at her before I could let myself love her. The anger was the door, not the destination.",
            timestamp: '00:13:44',
            momentId: 9,
            structures: ['emotion' as const, 'reflective' as const],
          },
          {
            quote: "I stopped saying 'she did her best.' Once I let that sentence go, I could see what actually happened. The seeing was painful. The pretending had been worse.",
            timestamp: '00:20:11',
            momentId: 14,
            structures: ['narrative' as const, 'cognitive' as const],
          },
          {
            quote: "I told my best friend the real story for the first time. She didn't flinch. That was the first moment I believed maybe I wasn't too much for the world.",
            timestamp: '00:28:33',
            momentId: 21,
            structures: ['social' as const, 'narrative' as const, 'emotion' as const],
          },
        ],
        journey: {
          early: ['emotion' as const, 'normative' as const],
          late: ['social' as const, 'reflective' as const],
          momentCount: 27,
        },
      },
      {
        ...
        ageRange: '26-35',
        gender: 'female',
        primaryTopic: 'Reclaiming the right to take up space',
        ...
        matchBasis: 'Same "I am too much" cognitive schema driving chest-tightness panic and approval-seeking behaviors in close relationships.',
        helpfulMoments: [
          {
            quote: "I started taking up more space in chairs on purpose. Sounds small, but my body hadn't been allowed to spread out in years. The chair didn't break. Neither did I.",
            timestamp: '00:07:48',
            momentId: 4,
            structures: ['body' as const, 'behaviour' as const],
          },
          {
            quote: "I noticed I was apologizing for being seen. Like, literally for existing in someone's field of view. Catching that was the first time I realized how small I'd made myself.",
            timestamp: '00:15:25',
            momentId: 9,
            structures: ['cognitive' as const, 'reflective' as const, 'social' as const],
          },
          {
            quote: "I let myself eat what I actually wanted at a restaurant once and cried in the parking lot. That's how foreign 'wanting' had become.",
            timestamp: '00:22:17',
            momentId: 14,
            structures: ['behaviour' as const, 'emotion' as const],
          },
        ],
        journey: {
          early: ['body' as const, 'social' as const],
          late: ['cognitive' as const, 'behaviour' as const],
          momentCount: 20,
        },
      },
    ],
    ...
    similarCases: [
      {
        ...
        ageRange: '26-35',
        gender: 'female',
        primaryTopic: 'Connecting childhood neglect to adult panic',
        ...
        matchBasis: 'Same schema-recognition moment: explicit linking of mother\'s emotional absence to current partner-withdrawal panic.',
        helpfulMoments: [
          {
            quote: "It clicked when I realized I was reacting to my partner the same way I reacted to my mom at age seven. Same body, same fear, just thirty years late.",
            timestamp: '00:10:45',
            momentId: 6,
            structures: ['cognitive' as const, 'narrative' as const, 'reflective' as const],
          },
          {
            quote: "Letting myself feel angry at my mother — instead of grateful she didn't hit me — broke something open. I'd spent decades being grateful for the absence of harm and counting it as love.",
            timestamp: '00:17:22',
            momentId: 11,
            structures: ['emotion' as const, 'reflective' as const],
          },
          {
            quote: "I started a practice every morning — putting one hand on my chest and saying out loud the thing I needed that day. Just naming it. The first week I cried every morning. By the third I was making coffee.",
            timestamp: '00:24:08',
            momentId: 16,
        ...
        journey: {
          early: ['body' as const, 'emotion' as const, 'social' as const],
          late: ['narrative' as const, 'reflective' as const, 'behaviour' as const],
          momentCount: 21,
        },
      ...
      },
      {
        ...
        ageRange: '36-45',
        gender: 'female',
        primaryTopic: 'Body-mediated insight into abandonment grief',
        ...
        matchBasis: 'Same body-first schema recognition: somatic awareness preceding and unlocking the cognitive insight, not following it.',
        helpfulMoments: [
          {
            quote: "A bodyworker noticed my throat was perpetually clenched and asked what wanted to be said. I started crying before I even knew what the words were.",
            timestamp: '00:09:15',
            momentId: 5,
            structures: ['body' as const, 'emotion' as const],
          },
          {
            quote: "I learned that my chest tightening wasn't a malfunction — it was a memory. My body had been doing the same protective thing since I was little. Once I respected that, I could ask it to try a different move.",
            timestamp: '00:15:38',
            momentId: 10,
            structures: ['body' as const, 'cognitive' as const, 'reflective' as const],
          },
          {
            quote: "What changed was when I stopped trying to fix the panic and started asking it what it wanted me to know. Treating my own body like a colleague instead of a problem.",
            timestamp: '00:22:50',
            momentId: 14,
            structures: ['body' as const, 'reflective' as const, 'narrative' as const],
          },
        ],
        journey: {
          early: ['body' as const, 'emotion' as const],
          late: ['reflective' as const, 'narrative' as const],
          momentCount: 23,
        },
      },
      {
        ...
        ageRange: '36-45',
        gender: 'female',
        primaryTopic: 'Catching the inherited dismissal pattern',
        ...
        matchBasis: 'Same schema-recognition turning point: noticing that the dismissal didn\'t stop with the parent — it had been continuing inside as self-talk for decades.',
        helpfulMoments: [
          {
            quote: "I caught myself rolling my eyes at my own feelings the same way she used to. Once I saw it, I couldn't unsee it. I was the one finishing her job.",
            timestamp: '00:12:18',
            momentId: 7,
            structures: ['cognitive' as const, 'reflective' as const],
          },
          {
            quote: "I started writing down what I needed each morning before I could talk myself out of it. Reading the list back to myself in my own voice was the first time I felt like I had an ally inside.",
            timestamp: '00:18:42',
            momentId: 12,
            structures: ['narrative' as const, 'behaviour' as const],
          },
          {
            quote: "Telling my sister I'd been quietly furious at our mom for years was terrifying. She didn't argue. She said 'me too.' That one moment broke a silence I'd carried alone.",
            timestamp: '00:25:55',
            momentId: 17,
            structures: ['social' as const, 'emotion' as const, 'narrative' as const],
          },
        ],
        journey: {
          early: ['emotion' as const, 'social' as const],
      ...
      },
      {
        ...
        ageRange: '26-35',
        gender: 'male',
        primaryTopic: 'Naming the attachment trigger that was driving the panic',
        ...
        matchBasis: 'Same catalytic insight: once the present-day trigger was consciously linked to a specific childhood scene, the somatic regulation tools started actually working.',
        helpfulMoments: [
          {
            quote: "I started naming it out loud the second it began — 'this is the nine-year-old, this is not now.' Saying it like a forecast made it lose its grip.",
            timestamp: '00:08:55',
            momentId: 5,
            structures: ['cognitive' as const, 'narrative' as const, 'reflective' as const],
          },
          {
            quote: "I noticed I'd stop breathing whenever my partner went silent. Just letting the next breath actually happen — on purpose — was a new skill I had to learn at thirty-two.",
            timestamp: '00:16:30',
            momentId: 11,
            structures: ['body' as const, 'behaviour' as const],
          },
          {
            quote: "I told my brother about the panic for the first time. He'd had his own version. We'd been in the same house and never said a word to each other. That conversation cracked something open.",
            timestamp: '00:23:12',
            momentId: 15,
            structures: ['social' as const, 'narrative' as const],
          },
        ...
        journey: {
          early: ['body' as const, 'emotion' as const],
          late: ['cognitive' as const, 'social' as const],
          momentCount: 20,
        },
      },
      {
        ...
        ageRange: '46-60',
        gender: 'female',
        primaryTopic: 'Letting anger toward a parent finally exist',
        ...
        representativeQuote: 'I protected my mother\'s reputation for thirty years. The day I let myself be angry at her was the day I started getting better.',
        matchBasis: 'Same anger-as-door schema moment: the loyalty defense ("she did her best") cracking and letting the underlying grief move.',
        helpfulMoments: [
          {
            quote: "I stopped policing my own anger toward her. The minute I let it actually be there, the panic that had been running underneath it for years had less to do.",
            timestamp: '00:13:50',
            momentId: 8,
            structures: ['emotion' as const, 'reflective' as const],
          },
          {
            quote: "I realized I'd been parenting my mother my whole life — managing her feelings, protecting her image. Once I named that, I could stop. Not all at once. But I could start.",
            timestamp: '00:20:24',
            momentId: 13,
            structures: ['cognitive' as const, 'social' as const, 'narrative' as const],
          },
          {
            quote: "I told a friend the unedited version of my childhood for the first time. She held my hand and said 'that was a lot for a little kid to carry.' I'd never let anyone say that to me before.",
            timestamp: '00:27:18',
            momentId: 19,
            structures: ['social' as const, 'narrative' as const, 'emotion' as const],
          },
        ...
        journey: {
          early: ['emotion' as const, 'normative' as const],
          late: ['social' as const, 'narrative' as const, 'reflective' as const],
          momentCount: 26,
        },
      },
      {
        ...
        ageRange: '36-45',
        gender: 'female',
        primaryTopic: 'A throat that finally said the unsaid thing',
        ...
        matchBasis: 'Same body-mediated schema insight: the throat holding the literal location of unspoken needs, and the panic loosening once a voice was put to them.',
        helpfulMoments: [
          {
            quote: "I noticed my throat tightened every time I was about to ask for something and stopped myself. Once I had the link, I could choose: speak through the tight throat anyway, or stay quiet and own that choice.",
            timestamp: '00:10:08',
            momentId: 6,
            structures: ['body' as const, 'cognitive' as const, 'reflective' as const],
          },
          {
            quote: "I started humming in the car. It sounds silly. But it was the first time my throat had made a sound for no reason in years. My body was relearning that sound was allowed.",
            timestamp: '00:17:44',
            momentId: 11,
            structures: ['body' as const, 'behaviour' as const],
          },
          {
            quote: "I asked my partner for a hug instead of waiting to be offered one. My voice shook. He hugged me. I cried for ten minutes about how long it had taken me to ask.",
            timestamp: '00:24:30',
            momentId: 16,
            structures: ['social' as const, 'emotion' as const, 'narrative' as const],
          },
    ...
    similarCases: [
      {
        ...
        ageRange: '26-35',
        gender: 'female',
        primaryTopic: 'Asking for what was needed and being met',
        ...
        matchBasis: 'Same consolidation milestone: the first direct, undefended need-expression to a partner met by attuned presence — the corrective experience that updated the old prediction.',
        helpfulMoments: [
          {
            quote: "I said the actual sentence — 'I need you to stay close right now' — and watched my body register that he stayed. The reps of that, over months, slowly rewrote what I expected from people.",
            timestamp: '00:11:20',
            momentId: 6,
            structures: ['social' as const, 'behaviour' as const, 'body' as const],
          },
          {
            quote: "I started parenting my own scared part. When the panic came I didn't try to silence her, I told her 'I see you, I'm here, you don't have to do this alone anymore.' Saying it to myself was the part I'd been waiting my whole life for someone else to do.",
            timestamp: '00:18:45',
            momentId: 12,
            structures: ['reflective' as const, 'narrative' as const, 'emotion' as const],
          },
          {
            quote: "The chest tightness started showing up less often, and when it did, it left faster. My body learned a new ending. It still remembers the old one, but it knows there's another option now.",
            timestamp: '00:26:10',
            momentId: 18,
            structures: ['body' as const, 'reflective' as const],
          },
      ...
      },
      {
        ...
        ageRange: '36-45',
        gender: 'female',
        primaryTopic: 'A body that learned what safety actually felt like',
        ...
        matchBasis: 'Same somatic consolidation marker: the shift from threat-pattern (tightness, bracing) to safety-pattern (warmth, openness) during a sustained corrective relationship.',
        helpfulMoments: [
          {
            quote: "I started checking in with my chest first thing every morning. The day I noticed it was warm and open before I even thought about it — that was the day I knew something underneath had actually changed.",
            timestamp: '00:09:50',
            momentId: 5,
            structures: ['body' as const, 'reflective' as const],
          },
          {
            quote: "I began letting my partner soothe me instead of going stiff under his hand. Receiving was harder than asking. But once I let it land in my body, I had a new reference point for what care actually feels like.",
            timestamp: '00:17:25',
            momentId: 11,
            structures: ['body' as const, 'social' as const, 'emotion' as const],
          },
          {
            quote: "I had to grieve the version of me who lived inside the tightness for so long. She kept me alive. Letting her rest was its own quiet ceremony I had to do alone.",
            timestamp: '00:25:40',
            momentId: 17,
            structures: ['narrative' as const, 'reflective' as const, 'emotion' as const],
          },
        ],
        journey: {
          early: ['body' as const, 'emotion' as const],
      ...
      },
      {
        ...
        ageRange: '36-45',
        gender: 'female',
        primaryTopic: 'Writing the story back from the inside',
        ...
        matchBasis: 'Same identity-reconstruction milestone: a written letter to the younger self that moved the deficit from "something wrong with me" to "something wrong with the room I was in."',
        helpfulMoments: [
          {
            quote: "I wrote the letter I'd needed to receive when I was eight. Reading it out loud to myself a week later, I noticed I believed parts of it. Not all. But more than zero. That was the start.",
            timestamp: '00:13:05',
            momentId: 7,
            structures: ['narrative' as const, 'reflective' as const, 'emotion' as const],
          },
          {
            quote: "I started keeping a small photo of myself as a kid on my desk. I'd glance at her during the workday and remember she was the one I was actually building this life for.",
            timestamp: '00:19:30',
            momentId: 12,
            structures: ['narrative' as const, 'behaviour' as const, 'reflective' as const],
          },
          {
            quote: "I told my partner the real childhood story — the one I'd always edited down. He didn't fix it or minimize it. He just said 'thank you for telling me.' That made me a different kind of known.",
            timestamp: '00:26:15',
            momentId: 18,
            structures: ['social' as const, 'narrative' as const],
          },
        ...
        journey: {
          early: ['emotion' as const, 'social' as const],
          late: ['narrative' as const, 'reflective' as const, 'cognitive' as const],
          momentCount: 27,
        },
      },
      {
        ...
        ageRange: '26-35',
        gender: 'male',
        primaryTopic: 'Holding sadness about a parent without losing myself',
        ...
        matchBasis: 'Same differentiation milestone: tolerating a parent\'s limitations as fact, not verdict on personal worth, with sadness that stays clean instead of collapsing into panic.',
        helpfulMoments: [
          {
            quote: "I started ending phone calls with my mother when I was full instead of when she was. The first time I said 'I need to go now' my hand shook. By the tenth time it didn't. The body learns.",
            timestamp: '00:10:55',
            momentId: 6,
            structures: ['behaviour' as const, 'social' as const, 'body' as const],
          },
          {
            quote: "I noticed sadness about her could come and go without becoming a referendum on whether I'm okay. That separation — her shape vs. my shape — turned out to be the work.",
            timestamp: '00:18:20',
            momentId: 11,
            structures: ['cognitive' as const, 'reflective' as const, 'emotion' as const],
          },
          {
            quote: "I let a couple of close friends become the people I tell things to first, instead of saving the news for her and being disappointed. Reorganizing who I report my life to changed how my life felt.",
            timestamp: '00:25:00',
            momentId: 16,
            structures: ['social' as const, 'narrative' as const],
          },
        ...
        journey: {
          early: ['emotion' as const, 'social' as const],
          late: ['cognitive' as const, 'social' as const, 'reflective' as const],
          momentCount: 22,
        },
      },
      {
        ...
        ageRange: '46-60',
        gender: 'female',
        primaryTopic: 'Becoming the steady adult my younger self never had',
        ...
        matchBasis: 'Same internalization shift: stopping the wait for external rescue and stepping in as a reliable adult presence for the younger self that was never met.',
        helpfulMoments: [
          {
            quote: "I started checking in with the scared part of me the way I'd want a good mother to check in. Out loud, in the car. 'How are you doing in there? What do you need today?' At first it felt absurd. Then it felt like home.",
            timestamp: '00:12:40',
            momentId: 7,
            structures: ['reflective' as const, 'narrative' as const, 'emotion' as const],
          },
          {
            quote: "I noticed I'd stopped abandoning myself in small ways — eating when hungry, resting when tired, leaving rooms that felt bad. Tiny acts of staying with myself were the actual structure of the change.",
            timestamp: '00:19:55',
            momentId: 13,
            structures: ['body' as const, 'behaviour' as const, 'reflective' as const],
          },
          {
            quote: "I told my husband 'I don't need you to fix me anymore. I need you to keep me company while I do it.' Something between us got easier the day I stopped outsourcing the job.",
            timestamp: '00:27:50',
            momentId: 20,
            structures: ['social' as const, 'narrative' as const],
          },
        ...
        journey: {
          early: ['emotion' as const, 'social' as const],
          late: ['reflective' as const, 'narrative' as const, 'body' as const],
          momentCount: 28,
        },
      },
      {
        ...
        ageRange: '36-45',
        gender: 'female',
        primaryTopic: 'Symptoms quieting while the deeper story keeps changing',
        ...
        matchBasis: 'Same consolidation-phase texture: somatic symptoms quiet first, and the slower identity-level reweaving keeps unfolding underneath in the months after.',
        helpfulMoments: [
          {
            quote: "I started naming my voice in conversations — 'I want to push back on that' or 'I have a different read.' Each small contradiction taught my body the room could hold me being separate.",
            timestamp: '00:11:35',
            momentId: 6,
            structures: ['social' as const, 'behaviour' as const, 'body' as const],
          },
          {
            quote: "I noticed I'd stopped scanning my partner's face for trouble every five minutes. The hypervigilance had been so constant I hadn't known it was a feature, not just my personality.",
            timestamp: '00:18:10',
            momentId: 11,
            structures: ['body' as const, 'reflective' as const, 'cognitive' as const],
          },
          {
            quote: "I started saying 'this is a Tuesday I get to live' instead of waiting for the next bad thing. Borrowing trust in ordinary days was the practice that made the days actually ordinary.",
            timestamp: '00:25:25',
            momentId: 16,
            structures: ['narrative' as const, 'reflective' as const, 'emotion' as const],
          },
