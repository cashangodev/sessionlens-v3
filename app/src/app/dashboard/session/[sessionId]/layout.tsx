  ...
  return (
    <div>
      ...
      <div className="mb-6">
        <Link
          href="/dashboard"
          className="inline-flex items-center gap-2 text-gray-500 hover:text-primary hover:bg-primary/5 px-3 py-2 rounded-lg text-sm"
        >
          ...
          {tabs.map((tab) => {
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-2.5 px-5 py-3.5 text-sm font-medium whitespace-nowrap border-b-2  ${
                  isActive
